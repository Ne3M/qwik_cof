...
export const Icons = component$(() => {
    ...
    return <svg xmlns="http://www.w3.org/2000/svg" class="u-hidden" aria-hidden="true">
        
        <symbol id="menu_underline_42px" viewBox="0 0 42 8" fill="none">
            <path d="M30.8144 2.32372C24.1302 1.80445 18.3507 0.0422967 7.97653 1.04737C2.86617 1.53783 0.411256 3.41787 0.176942 3.92637C0.112325 4.01515 0.0477098 4.10393 0.0718687 4.25733C0.039269 5.04846 1.20967 5.49293 1.38723 5.62217C8.15962 7.69955 18.6141 7.70363 24.5156 7.24577C32.7663 6.73231 42.1398 4.86304 41.6475 4.23316C41.1553 3.60328 34.6167 2.51088 30.8144 2.32372Z" fill="#D0103A"/>
        </symbol>

        <symbol id="attention_25px" viewBox="0 0 25 24" fill="none">
            <path d="M22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12Z" fill="#D0103A"/>
            <path d="M12 6.25C12.4142 6.25 12.75 6.58579 12.75 7V13C12.75 13.4142 12.4142 13.75 12 13.75C11.5858 13.75 11.25 13.4142 11.25 13V7C11.25 6.58579 11.5858 6.25 12 6.25Z" fill="white"/>
        ...
        <symbol id="arrow_19px" viewBox="0 0 19 12" fill="none">
            <path d="M17.5 6L1.5 6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12.5 11C12.5 11 17.5 7.31756 17.5 5.99996C17.5 4.68237 12.5 1 12.5 1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </symbol>

        <symbol id="close_48px" viewBox="0 0 48 48">
